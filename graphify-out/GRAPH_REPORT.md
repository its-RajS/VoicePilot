...
## Corpus Check
- 125 files · ~68,214 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1562 nodes · 1788 edges · 202 communities (190 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ddf2429`
...
- `No Default Logging Of Audio Or Prompts` --implements--> `Offline And Privacy-First Operation`  [INFERRED]
  mvp-voicePilot/CONTRIBUTING.md → docs/product-specification.md
- `Hybrid Local-First Architecture` --implements--> `Modular Replaceable Service Boundaries`  [EXTRACTED]
  mvp-voicePilot/docs/architecture.md → docs/product-specification.md
- `Any` --uses--> `PipelineOrchestrator`  [INFERRED]
  inference/src/voicepilot_inference/ipc_server.py → inference/src/voicepilot_inference/core/pipeline.py
- `bytes` --uses--> `PipelineOrchestrator`  [INFERRED]
  inference/src/voicepilot_inference/ipc_server.py → inference/src/voicepilot_inference/core/pipeline.py
...
Cohesion: 0.06
Nodes (30): Abort Operations, Automated Bisect, Before Creating PR, Bisect Workflow, Cherry-Pick Multiple Commits, Cherry-Pick (Selective Commits), Cherry-Pick Workflow, Common Conflict Scenarios (+22 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (28): dependencies, lucide-react, react, react-dom, @tauri-apps/api, typescript, vite, @vitejs/plugin-react (+20 more)
...
Cohesion: 0.08
Nodes (23): Acceptance Criteria Parsing, Adding Comments, Authoritative References, Common Operations, Create Sub-Issue, Creating Issues, Dev Evidence Template, Done Evidence Template (+15 more)
...
Cohesion: 0.17
Nodes (17): Connection, ProjectDirs, ConfigService, load_initializes_and_returns_defaults(), split_modifiers(), AppConfig, Option, PathBuf (+9 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (21): Approval Policies, Available Skills (18), Codex CLI Configuration, Codex Not Finding Instructions, Configuration: .codex/config.toml, Dark Factory Compatibility, Directory Structure, Environment Variables (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (21): Accessibility Checklist, Admin Verification, Analytics Patterns, Authentication Patterns, Authoritative References, Client Component Auth, Common Mistakes to Avoid, Component Library Patterns (+13 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (23): Client, Into, OllamaModel, OllamaTagModel, LiveOverlay(), OllamaService, OllamaTagModel, OllamaTagsResponse (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (21): Agent Teams vs Subagents vs Background Agents, Authoritative References, Broadcast (Use Sparingly -- Expensive), Communication Patterns, Direct Messages (Most Common), Known Limitations, Pattern 1: TDM as Team Lead, Pattern 2: Task Dependencies for Quality Gates (+13 more)

### Community 16 - "Community 16"
Cohesion: 0.10
Nodes (20): Admin Policy, Authoritative References, CORRECT Patterns, FORBIDDEN Patterns, Migration Checklist, Migration Patterns Skill, Migration Workflow (MANDATORY), Production Migration Requirements (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.10
Nodes (20): Anti-Patterns to Avoid, Authoritative References, Checkpoint Pattern, Escalation Patterns, Escalation Template, Evidence-Based Delivery, Evidence Types, Long-Running Task Checkpoints (+12 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (19): Admin Pages: Force Dynamic Rendering, Admin/System Tables (Role-Based), ALWAYS Do This, API Route with User Context, Authoritative References, Common Patterns, Context Helper Reference, Critical Rules (+11 more)
...
Cohesion: 0.11
Nodes (17): 1. RLS Validation, 2. Authentication Checks, 3. Credential Scanning, 4. Dependency Vulnerabilities, 5. Input Validation, Authoritative References, CORRECT Patterns, FORBIDDEN Patterns (+9 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (17): API Routes, Authoritative References, Canonical Code References, Common Patterns, Configuration, Create Checkout Session, Critical Rules, Evidence Template for Ticket System (+9 more)
...
Cohesion: 0.12
Nodes (29): Child, ChildStdin, ChildStdout, Drop, IpcProcess, IpcRequest, IpcResponse, Path (+21 more)

### Community 46 - "Community 46"
Cohesion: 0.12
Nodes (16): Acceptance Criteria Patterns, Authoritative References, CORRECT Patterns, Data Criteria, Error Criteria, Evidence for Ticket System, FORBIDDEN Patterns, Output Locations (+8 more)

### Community 47 - "Community 47"
Cohesion: 0.12
Nodes (15): API Documentation Template, API Patterns Skill, API Route Checklist, API Route Template, Authoritative References (MUST READ), CORRECT Patterns, Error Response, FORBIDDEN Patterns (+7 more)
...
Cohesion: 0.15
Nodes (12): Authoritative References (MUST READ), Branch to Environment Mapping, Deployment Evidence Template, Deployment SOP Skill, FORBIDDEN, Post-Deployment Smoke Test, Pre-Deployment Checklist, Purpose (+4 more)
...
Cohesion: 0.15
Nodes (12): Bad agent brief, Behavioral, not procedural, Complete acceptance criteria, Durability over precision, Examples, Explicit scope boundaries, Good agent brief (bug), Good agent brief (enhancement) (+4 more)
...
Cohesion: 0.18
Nodes (10): Agent skills, Domain docs, Environment, Issue tracker, Key Paths, Purpose, Safety Gates, Validation Expectations (+2 more)

### Community 63 - "Community 63"
Cohesion: 0.18
Nodes (10): CORRECT, Critical Rules, Evidence Template, FORBIDDEN, Purpose, Reference, Test Commands, Test Directory Structure (+2 more)
...
Cohesion: 0.20
Nodes (9): ADR Template (Architecture Decision Record), Architecture Document Template, Confluence Documentation Skill, Documentation Checklist, Documentation Output Locations, Knowledge Transfer (KT) Document Template, Purpose, Runbook Template (+1 more)
...
Cohesion: 0.20
Nodes (9): Pattern Discovery Protocol, Pattern Discovery Skill, Pattern Matching Guide, Purpose, Reference, Step 1: Check Pattern Library, Step 2: Review Pattern Index, Step 3: Apply or Escalate (+1 more)

### Community 68 - "Community 68"
Cohesion: 0.20
Nodes (9): Branch Naming Convention, Commit Message Format, Evidence Template, Pre-PR Checklist, Purpose, Rebase-First Workflow, Reference, SAFe Workflow Skill (+1 more)
...
Cohesion: 0.22
Nodes (9): commands, description, identifier, commands, description, identifier, permissions, allow-emit-to (+1 more)
...
Cohesion: 0.29
Nodes (6): Development baseline, Development bootstrap, First milestone, MVP scope, Project layout, VoicePilot
...
Cohesion: 0.33
Nodes (5): 1. Frame the problem space, 2. Spawn sub-agents, 3. Present and compare, Design It Twice, Process
...
Cohesion: 0.40
Nodes (5): writing-great-skills, computedHash, skillPath, source, sourceType
...
Cohesion: 0.67
Nodes (3): core:event, global_scope_schema, permission_sets
...
## Knowledge Gaps
- **913 isolated node(s):** `allow`, `target`, `module`, `moduleResolution`, `lib` (+908 more)
...
- **Why does `deny` connect `Community 54` to `Community 128`, `Community 0`, `Community 129`, `Community 130`, `Community 131`, `Community 5`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 138`, `Community 8`, `Community 139`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 145`, `Community 146`, `Community 147`, `Community 148`, `Community 149`, `Community 151`, `Community 152`, `Community 153`, `Community 154`, `Community 155`, `Community 156`, `Community 157`, `Community 158`, `Community 159`, `Community 160`, `Community 161`, `Community 162`, `Community 163`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 168`, `Community 169`, `Community 170`, `Community 171`, `Community 172`, `Community 55`, `Community 79`, `Community 124`, `Community 125`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `allow` connect `Community 55` to `Community 128`, `Community 0`, `Community 129`, `Community 130`, `Community 131`, `Community 5`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 138`, `Community 8`, `Community 139`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 145`, `Community 146`, `Community 147`, `Community 148`, `Community 149`, `Community 151`, `Community 152`, `Community 153`, `Community 154`, `Community 155`, `Community 156`, `Community 157`, `Community 158`, `Community 159`, `Community 160`, `Community 161`, `Community 162`, `Community 163`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 168`, `Community 169`, `Community 170`, `Community 171`, `Community 172`, `Community 54`, `Community 79`, `Community 124`, `Community 125`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `permissions` connect `Community 5` to `Community 129`, `Community 131`, `Community 132`, `Community 133`, `Community 135`, `Community 136`, `Community 137`, `Community 138`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 146`, `Community 148`, `Community 153`, `Community 154`, `Community 159`, `Community 161`, `Community 162`, `Community 163`, `Community 53`, `Community 55`, `Community 125`?**
